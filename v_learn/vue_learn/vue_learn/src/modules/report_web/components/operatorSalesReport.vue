            ...
            <div class="salesReport_list">
                ...
                <div v-loading="loadingTableListData" element-loading-text="Loading">
                    <el-table :data="salesReportListData.headBean" style="width: 100%;font-size: 12px" :default-sort="{ prop: 'orderDate',order: 'descending' }" class="salesReport_list_table">
                        ...
                        <el-table-column prop="description" class-name="list_table_column" width="130" label="Description" align="left" ></el-table-column>
                        <el-table-column prop="quantity" label="Quantity" width="70" align="right">
                            <template slot-scope="scope">
                                {{ scope.row.quantity | formatNumber }}
                            </template>
                        </el-table-column>
                        <el-table-column prop="unitPrice" class-name="list_table_column" label="Unit Price" align="right">
                            <template slot-scope="scope">
                                {{ scope.row.unitPrice | formatNumber }}
                            </template>
                        </el-table-column>
<!--                        <el-table-column prop="retailCost"  class-name="list_table_column" label="Unit Cost" align="right">
                            <template slot-scope="scope">
                                {{ scope.row.retailCost | formatNumber }}
                            </template>
                        </el-table-column>-->
                        <el-table-column prop="subTotal" label="Sub Total" align="right">
                            <template slot-scope="scope">
                                {{ scope.row.subTotal | formatNumber }}
                            </template>
                        </el-table-column>
<!--                        <el-table-column prop="totalRetailCostPrice" label="Cost" align="right">
                            <template slot-scope="scope">
                                {{ scope.row.totalRetailCostPrice | formatNumber }}
                            </template>
                        </el-table-column>-->
                        <el-table-column prop="adjustment" class-name="list_table_column" label="Adjustment" align="right">
                            <template slot-scope="scope">
                                {{ scope.row.adjustment | formatNumber }}
                            </template>
                        </el-table-column>
                        <el-table-column prop="payment" label="Payment" align="center"></el-table-column>
                        <el-table-column prop="receivables" class-name="list_table_column" label="Receivables" align="right">
                            <template slot-scope="scope">
                                {{ scope.row.receivables | formatNumber }}
                            </template>
                        </el-table-column>
                        <el-table-column prop="salesChannel" class-name="list_table_column" label="Sales Channel" align="center"></el-table-column>
                        <el-table-column prop="storeName" class-name="list_table_column" label="Store" align="left"></el-table-column>
                    </el-table>
            ...
            <div class="salesReport_sum">
                ...
                <div v-loading="loadingTableSumData" element-loading-text="Loading">
                    <el-table :data="salesReportSumData.footerBean" style="width: 100%;font-size: 12px" :default-sort="{ prop: 'date',order: 'descending' }" class="salesReport_sum_table">
                        ...
                        <el-table-column prop="telegraphicTransfer" label="Telegraphic Transfer" align="right"></el-table-column>
                    </el-table>
...
export default {
    ...
    methods: {
        ...
        searchSalesReport (paramsList) {
            ...
            Promise.all([salesReportListPromise, salesReportSumPromise]).then(function () {
