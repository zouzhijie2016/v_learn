  ...
  export default {
      ...
      methods:{
          ...
          searchRequireList(params, isOnlyList = false){
              ...
              var paramsContent = Object.assign({}, t.getParams(), {
                  pageNum: params || t.searchForm.curpage,
                  isOnlyList: isOnlyList
              })

              this.searchForm.searchLoading = true;
              this.$getCommonPageListApi(warehouseApi.toApproveByKeeper, paramsContent, d => {
          ...
          approveDialogEvt(data){
              ...
              warehouseApi.findInventoryRequieApplication({
                  ...
                  if (d.success == true) {
                      if(d.data && d.data.status == 3){
                          window.open('/warehouse_web/index.html#/warehouseApproveApplication?id=' + data.id);
                      }else{
                          this.searchRequireList(1);
                      }
                  } else {
          ...
          viewDialogEvt(data){
              ...
              window.open('/warehouse_web/index.html#/viewOperatorApplication?type=warehouse&id=' + data.id);
          },
          getLessSixMonth (d) {
