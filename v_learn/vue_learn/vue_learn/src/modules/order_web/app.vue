<template>
    <div>
      ...
      <g-header v-if="!$route.meta.isHeaderHide"></g-header>
        <div id="order_contentarea">
            <keep-alive>
      ...
      <g-footer v-if="!$route.meta.isFooterHide"></g-footer>
    </div>
</template>
<script>
...
export default {
    ...
    mounted () {
        ...
        console.log('excuted order web index mounted!!!')
    },
    computed: {
        ...mapState([
