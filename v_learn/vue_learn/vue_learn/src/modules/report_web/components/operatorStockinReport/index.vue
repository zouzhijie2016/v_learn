<template>
    <div class="operatorstockin_box">
        <div class="search_box">
            <div class="search_title">
                Operator Stockin Report
            </div>
            <div class="search_content">
                ...
                <el-row :gutter="5">
                    ...
                    <el-col :span="4">
                        <el-button type="primary" @click="searchStockInReport" icon="el-icon-search" :loading="listLoading">
                            Search
                        </el-button>
                    </el-col>
                </el-row>
        ...
        <div class="table_box" >
            ...
            <div class="list_box" v-loading="listLoading" element-loading-text="Loading">
                <el-table :data="list"
                          ...
                          empty-text="There is no Operator Stockin Report data.">
...
export default {
    ...
    methods: {
        ...
        queryOperatorReportDataApi (isOnlyList = false) {
            ...
            this.$getCommonPageListApi(ReportApi.queryOperatorReportData, {
                productId: this.search.productId,
                facilityId: this.search.warehouseId,
                startDate: this.getServerTimeStamp(this.search.startDate),
                endDate: this.getMaxServerTimeStamp(this.search.endDate),
...
<style scoped>
    ...
    .operatorstockin_box .search_box {
        background: #fff;
        overflow: hidden;
        min-height: 100px;
