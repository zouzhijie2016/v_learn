<template>
    <div class="stockOutReport_box">
        <div class="stockOutReport_title">Stockout Report</div>
        ...
        <div class="stockOutReport_content">
            <div class="stockOutReport_toolBar">
                <div class="stockOutReport_toolBar_title">Stockout Report List</div>
            ...
            <div v-loading="loadingTableData" element-loading-text="Loading">
                <el-table :data="stockOutReportListData.list" style="width: 100%;font-size: 12px" :default-sort="{ prop: 'transferCompleteDate',order: 'descending' }">
                    ...
                    <el-table-column prop="shipNumber" label="Shipment Quantity" align="right"></el-table-column>
                    <el-table-column prop="transferNumber" label="Transfer Quantity" align="right"></el-table-column>
