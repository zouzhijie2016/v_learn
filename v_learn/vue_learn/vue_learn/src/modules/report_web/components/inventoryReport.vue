<template>
    <div>
        <div class="inventoryReport_box">
            <div class="inventoryReport_title">Inventory Report</div>
            ...
            <div class="inventoryReport_content">
                <div class="inventoryReport_list">
                    <div class="inventoryReport_list_toolBar">
                        <div class="inventoryReport_list_title">Inventory Report List</div>
                    ...
                    <div v-loading="loadingTableListData" element-loading-text="Loading">
                        <el-table :data="inventoryReportListData.list" style="width: 100%;font-size: 12px;" :default-sort="{ prop: 'recordDate',order: 'descending' }" class="inventoryReport_list_table">
                            ...
                            <el-table-column class-name="list_table_column" label="Unit Cost" align="right">
                                <template slot-scope="scope">
                                    {{ scope.row.avgCost | formatNumber }}
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column class-name="list_table_column" label="Sub Total Cost" align="right">
                                <template slot-scope="scope">
                                    {{ scope.row.qoh * scope.row.avgCost | formatNumber }}
                                </template>
                            </el-table-column>
    ...
    methods: {
        ...
        exportInventoryReportList () {
            ...
            ReportApi.exportReportData(this.getParams(), {
                ...
                download(res.data, res.headers['x-filename'] || 'inventoryExport.csv')
            }).catch(err => {
                this.searchForm.exportListLoading = false
                this.$showErrorMessage(err)
            })
