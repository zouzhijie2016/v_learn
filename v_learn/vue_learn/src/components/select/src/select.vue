      ...
      <span v-if="collapseTags && selected.length">
        <el-tag
          ...
          <template v-if=" selected.length > 1" >
              <el-popover ref="omittab" @show="updatePopoverZIndex"
                          placement="top"
                          trigger="hover">
                <div class="el-select" :style="{'max-width': inputWidth+'px'}">
                  <el-scrollbar tag="div"
                                view-class="el-select-dropdown__list"
                                wrapStyle="max-height:274px;padding-right: 14px;"
                  >
                    <el-tag
                        v-for="item in remainSelected"
...
//      ElScrollbar
    ...
    methods: {
        updatePopoverZIndex() {
          let curPopoverInstance = this.$refs['omittab'];
          if(!!curPopoverInstance) {
              curPopoverInstance.updatePopper();
          }
        },
